function [P, Pn] = AnDarksamtest_out(X, alpha)
%Same as 'ANDARKSAMTEST' except that output argument is used to convey
%numeric result of significance test. First output argument assumes ties,
%second assumes no ties
%If not output argument present, function displays test.

%Outputs
%P = significance of hypothesis, adjusted for ties (i.e. same values in
%distribution)
%Pn = significance of hypothesis, not adjusted for ties
