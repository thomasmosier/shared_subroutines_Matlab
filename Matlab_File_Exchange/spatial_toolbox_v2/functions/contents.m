...
fdoubly2 - doubly stochastic scaling
...
dotplot2 - plots a variable over space with symbol size increasing with the values of the variable
min_eig2 - estimates minimum eigenvalue of a weight matrix
