function tab2(y, info)
%PURPOSE: print an (nobs x nvar) matrix in formatted form with an optional title
%---------------------------------------------------
% USAGE:     tab2(x,info) 
...
%        info.caption=a string containing the table title
%---------------------------------------------------
% e.g.   in.cnames = strvcat('col1','col2');
%        in.rnames = strvcat('rowlabel','row1','row2');
%        tab2(y,in), prints entire matrix, column and row headings
%        in2.endc = 3; in2.cnames = strvcat('col1','col2','col3');
%    or: tab2(y,in2), prints 3 columns of the matrix, just column headings 
%    or: tab2(y), prints entire matrix, no column headings or row labels 
...
%---------------------------------------------------
% SEE ALSO: tsprint, mprint_d, lprint, mprint
%---------------------------------------------------
%
%INFO:
%
%This is just the mprint function of James LeSage, www.spatial-econometrics.com, with the minor addition of
%an optional title when info.caption is defined.
%
%Written by Kelley Pace, www.spatial-statistics.com, 1/28/03
...
%%%%%%%%%%%%%%%%%% Addition to mprint code %%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%printing title when info.caption is present

if isfield(info,'caption')==1
     fprintf(fid,'%s ', info.caption);  
     fprintf(fid,'\n');
 end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
