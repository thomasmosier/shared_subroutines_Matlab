...
meanbmaxs=mean(bmaxs')';
 ...
 %true and estimated regression parameters printed via 
 %James LeSage's function from www.spatial-econometrics.com
 ...
 info2.rnames=strvcat('MESS times',' simulation time ',' estimation time ');
 mprint([mess_simulation_time; mess_estimation_time], info2)
