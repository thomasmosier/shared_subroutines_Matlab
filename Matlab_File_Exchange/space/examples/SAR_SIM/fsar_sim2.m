...
%supplied random variables, rv. The rvcorr are simultaneous autoregressive random variables.
%
%
%INPUTS:
%
%d is a n by n weight matrix
%
...
z=s1-alpha*d-alpha*d'+alpha*alpha*d*d;
%creates I-aD

p=symamd(z);
%finds symmetric approximate minimum degree permutation
